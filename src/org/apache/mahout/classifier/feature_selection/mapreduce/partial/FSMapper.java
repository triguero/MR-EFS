...
import org.apache.mahout.classifier.feature_selection.mapreduce.MapredMapper;
...
public class FSMapper extends MapredMapper<LongWritable,Text,StrataID,MapredOutput> {
  ...
  protected void cleanup(Context context) throws IOException, InterruptedException {
    ...
    for(int i=0; i<selected.length;i++){
    	if(selected[i]) System.out.println("Seleccionada característica: "+i);
    }
      
    MapredOutput emOut = new MapredOutput(selected,null);
